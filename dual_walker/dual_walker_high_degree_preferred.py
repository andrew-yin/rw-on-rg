...
class DWRandomHighDegreePreferred(DualWalker):
    """
    The agent will prefer nodes with higher degree (transformation function is the cdf of normal)
    """
    def __init__(self):
        self.claimed1 = None
        self.claimed2 = None
    ...
    def load_graph(self, graph):
        ...
        for i in range(len(graph)):
            ...
            if len(set(neighbor_degrees)) > 1:
                ...
                neighbor_statistics = norm(loc = 0, scale = 1).cdf(neighbor_zscore)
